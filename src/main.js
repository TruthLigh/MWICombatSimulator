...
function initSimulationControls() {
    ...
    let mazeDifficultyInput = document.getElementById("inputMazeDifficulty");
    if (mazeDifficultyInput) { mazeDifficultyInput.value = 100; }
...
function startSimulation(selectedPlayers) {
    ...
    let simulationTimeInput = document.getElementById("inputSimulationTime");
    let mazeDifficultyInput = document.getElementById("inputMazeDifficulty");
    let mazeDifficulty = Math.max(1, Math.floor(Number(mazeDifficultyInput?.value) || 100));
    ...
    if (!simAllZonesToggle.checked && !simAllSoloToggle.checked) {
        ...
        let workerMessage = {
            ...
            zone: { zoneHrid: zoneHrid, difficultyTier: difficultyTier, mazeDifficulty: mazeDifficulty },
        ...
        let simHrids = Object.values(targetHrids)
            ...
            .map(action => {
                ...
                for (let difficultyTier = 0; difficultyTier <= action.maxDifficulty; difficultyTier++) {
                    result.push({ zoneHrid: action.hrid, difficultyTier: difficultyTier, mazeDifficulty: mazeDifficulty });
                }
                return result;
            })
            .flat();
